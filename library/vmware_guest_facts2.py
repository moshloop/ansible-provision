...
def main():
    ...
    argument_spec.update(
        ...
        wait_for_ip_address_subnet=dict(type='str', default=''),
    ...
    if module.params['wait_for_ip_address_subnet'] != '':
        pyv.wait_for_vm_ip(vm, module.params['wait_for_ip_address_timeout'])
    ...
    if vm:
        try:
            ...
            instance['wait_for_ip_address_subnet'] = module.params['wait_for_ip_address_subnet']
            if module.params['wait_for_ip_address_subnet'] != '':
                net = netaddr.IPNetwork(module.params['wait_for_ip_address_subnet'])
                for nic in vm.guest.net:
                    for adr in nic.ipConfig.ipAddress:
                        if adr.ipAddress in net:
                            instance["ipv4"] = adr.ipAddress
